...
const Home = () => {
    return (
        <Container className="mt-5">
            ...
            {/* Alternating Images and Content */}
            <Row className="align-items-center mb-4">
                <Col md={6}>
                    <img src={image1} alt="HRMS" className="img-fluid rounded shadow" />
                </Col>
                <Col md={6}>
                    <Card className="text-white bg-primary p-3 shadow">
                        <Card.Body>
            ...
            <Row className="align-items-center mb-4">
                <Col md={6} className="order-md-2">
                    <img src={image2} alt="HRMS" className="img-fluid rounded shadow" />
                </Col>
                <Col md={6} className="order-md-1">
                    <Card className="text-white bg-success p-3 shadow">
                        <Card.Body>
            ...
            <Row className="align-items-center">
                <Col md={6}>
                    <img src={image3} alt="HRMS" className="img-fluid rounded shadow" />
                </Col>
                <Col md={6}>
                    <Card className="text-white bg-info p-3 shadow">
                        <Card.Body>
